...
<div class="flex min-h-screen flex-col items-center justify-center -my-16 lg:-my-24 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <form class="space-y-6" action="#" method="POST">
            ...
            <div>
            <button type="submit" class="flex w-full justify-center rounded-md border border-transparent bg-sky-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">Sign in</button>
            </div>
        </form>
