    ...
    <div class="flex min-h-screen flex-col items-center justify-center -my-16 lg:-my-24 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <form class="space-y-6" action="#" method="POST">
                ...
                <div>
                <button type="submit" class="flex w-full justify-center btn btn-primary">Sign in</button>
                </div>
            </form>
            ...
            <div class="mt-6">
                ...
                <div>
                    <a href="#" class="inline-flex w-full justify-center rounded-full border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50">
